...
// <pre class="codegen"><code class="language-python">{code}</code></pre>`;
        var codegen_html_template = `
    <p>Tasks and rewards generated by GPT-4 (<a href="{link}">raw text file</a>):</p>
    <pre class="codegen"><code class="language-python">{code}</code></pre>`;
    $('[id^="code_"]').each(function() {
        ...
        var codegen_file = './static/tasks/' + domain_name + '/' + cmd_idx_str + '.txt'; /* ./static/codegen/pepper/1.txt */
