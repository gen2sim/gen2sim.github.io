...
// <pre class="codegen"><code class="language-python">{code}</code></pre>`;
        var codegen_html_template = `
    <p>Tasks and rewards generated by our Language Model Program (<a href="{link}">raw text file</a>):</p>
    <pre class="codegen"><code class="language-python">{code}</code></pre>`;
    $('[id^="code_"]').each(function() {
        var id = this.id; /* code_pepper_1 */
        domain_name_cmd_idx = id.substring(5); /* pepper_1 */
        ...
        var codegen_file = './static/codegen/' + domain_name + '/' + cmd_idx_str + '.txt'; /* ./static/codegen/pepper/1.txt */
